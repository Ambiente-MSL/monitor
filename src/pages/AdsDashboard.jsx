                ...
                {shouldShowAdsFallback && adsFallbackProps ? (
                  ...
                  >
                    <thead>
                      ...
                      >
                        <th style={{ textAlign: "left", padding: "8px 12px", width: "30%" }}>Anúncio</th>
                        <th style={{ textAlign: "left", padding: "8px 12px", width: "24%" }}>Campanha</th>
                        <th style={{ textAlign: "right", padding: "8px 12px", width: "12%" }}>Impressões</th>
                        <th style={{ textAlign: "right", padding: "8px 12px", width: "11%" }}>Cliques</th>
                        <th style={{ textAlign: "right", padding: "8px 12px", width: "9%" }}>CTR</th>
                        <th style={{ textAlign: "right", padding: "8px 12px", width: "14%" }}>Investimento</th>
                      </tr>
                    </thead>
                    <tbody>
